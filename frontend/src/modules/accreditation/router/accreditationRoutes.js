...
export default [
  ...
  },
  {
    ...
    children: [
      ...
      { path: "staff-dashboard", component: StaffApplications, meta: { allowedRoles: ["tourism_staff", "tourism_officer"] } },
      { path: "review", component: ApplicationReview, meta: { allowedRoles: ["tourism_staff", "tourism_officer", "admin"] } },
      { path: "records", component: AccreditationRecords, meta: { allowedRoles: ["tourism_staff", "tourism_officer", "admin"] } },
      { path: "reports", component: ReportsPage, meta: { allowedRoles: ["tourism_staff", "tourism_officer", "admin"] } },
