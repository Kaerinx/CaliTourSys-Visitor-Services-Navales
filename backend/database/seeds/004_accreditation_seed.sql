...
FROM (
  VALUES
    ('System Administrator', 'System', 'Administrator', 'system.admin@tourism.gov.ph', '$2b$10$J6raAyuk4ja52jaBTHhQBeXK7Z4W6iNTWcyX8TEdlSu9M6KjhpeBO', '+63 900 000 0000', 'admin', 'active'),
    ('Maria Santos', 'Maria', 'Santos', 'maria.santos@tourism.gov.ph', '$2b$10$J6raAyuk4ja52jaBTHhQBeXK7Z4W6iNTWcyX8TEdlSu9M6KjhpeBO', '+63 911 111 1111', 'tourism_staff', 'active'),
    ('John Martinez', 'John', 'Martinez', 'john@sunsetresort.com', '$2b$10$J6raAyuk4ja52jaBTHhQBeXK7Z4W6iNTWcyX8TEdlSu9M6KjhpeBO', '+63 912 345 6789', 'business_owner', 'active')
) AS seed(display_name, first_name, last_name, email, password_hash, phone, role, status)
WHERE NOT EXISTS (
...
UPDATE users
SET
  first_name = COALESCE(users.first_name, seed.first_name),
  last_name = COALESCE(users.last_name, seed.last_name),
  phone = COALESCE(users.phone, seed.phone),
  role = COALESCE(users.role, seed.role),
  email_verified_at = COALESCE(users.email_verified_at, NOW()),
  updated_at = NOW()
FROM (
  VALUES
    ('System', 'Administrator', 'system.admin@tourism.gov.ph', '+63 900 000 0000', 'admin'),
    ('Maria', 'Santos', 'maria.santos@tourism.gov.ph', '+63 911 111 1111', 'tourism_staff'),
    ('John', 'Martinez', 'john@sunsetresort.com', '+63 912 345 6789', 'business_owner')
) AS seed(first_name, last_name, email, phone, role)
